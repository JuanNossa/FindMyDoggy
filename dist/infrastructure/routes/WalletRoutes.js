...
router.post('/transfer', (0, asyncHandler_1.asyncHandler)(async (req, res) => {
    ...
    // Aquí se debe implementar la lógica real de transferencia: validar monto, restar del emisor, sumar al receptor.
    // Para este ejemplo, devolvemos un mensaje simulado.
